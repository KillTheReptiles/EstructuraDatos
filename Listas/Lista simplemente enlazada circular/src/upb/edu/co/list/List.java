...
public class List implements ListInterface, Iterable<ListNode> {
    ...
    public ListNode search(Object object) {
        ...
        ListNode nodo = null;
        for (ListNode buscar = head; buscar != tail.next; buscar = buscar.next) {
    ...
    public boolean insert(ListNode node, Object object) {
        if (node != null) {
            inode = this.search(node);
            if (inode.next == tail.next) {
                add(object);
            } else {
    ...
    public List subList(ListNode from, ListNode to) {
        List rango = new List();
        for (ListNode buscar = from; buscar != tail.next; buscar = buscar.next) {
    ...
    public Iterator<ListNode> iterator() {
        ...
        Iterator<ListNode> i = new Iterator<ListNode>() {
            ...
            public boolean hasNext() {
                return ni.next != tail.next ? true : false;
            }
